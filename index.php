    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-xl shadow-2xl overflow-hidden">
            ...
            <div id="forgot-password-modal"
                class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 z-50 flex items-center justify-center p-4 rounded-xl">
                <div class="bg-white rounded-xl shadow-xl max-w-md w-full">

                    <!-- modal header -->
                    <div
                        class="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4 text-white flex justify-between items-center">
                    ...
                    <div class="p-6 " id="forgot-step-1">
                        ...
                        <div id="forgot-message"
                            class="hidden mt-2 p-3 rounded-lg text-sm text-center text-red-500 font-bold"></div>
                        <div class="mb-2">
                    ...
                    <div class="p-6 hidden" id="forgot-step-3">
                        ...
                        <div class="flex gap-3">
                            <button type="button" onclick="resetPassword();"
                                ...
                                Password</button>
                            <button type="button" onclick="closeForgotPasswordModal();"
                                class="flex-1 text-gray-700 bg-gray-300 font-semibold py-2 rounded-1g hover:bg-gray-400">Cancel</button>
                        </div>
                    </div>
                </div>
            </div>
