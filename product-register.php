            ...
            <form id="productForm" enctype="multipart/form-data" class="p-8">
               ...
               <!-- product title  -->
                ...
                <div class="mb-6">
                    ...
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500
                    focus:border-transparent outline-none transition" maxlength="1000" ></textarea>
                ...
                <!-- product img -->
                 ...
                 <!-- error message -->
                 <div id="form-message" class="mb-6 p-4 rounded-lg hidden">
                  <!-- This div is ONLY for showing error/success messages -->
                   </div>
     ...
     productForm.addEventListener("submit",async (e)=> {
        ...
        if(!productTitle){
           ...
           try{
                ...
                if(result == "success"){
                   window.location.href = "product-register.php?success=Product Registerd Successfully";
                }else{
                    showError(result);
                }
