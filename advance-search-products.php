      ...
      <div class="group bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col overflow-hidden h-full">
        <div class="relative aspect-video bg-gray-100 overflow-hidden">
          ...
          <?php if($loggedIn && $userRole == "buyer"): 
                ...
                data-product-id="<?php echo $product["id"]; ?>" data-in="<?php echo $inwl ? 1 : 0; ?>"
                title="<?php echo $inwl ? "Remove from watchlist" : "Add to watchlist"; ?>">
                   <svg class="w-5 h-5" fill="<?php echo $inwl ? 'currentColor' : 'none'; ?>" 
    ...
    grid.addEventListener("click", async (e)=>{
           ...
           try{
            ...
            if(j.success){
              ...
              btn.classList.toggle('text-gray-500', !inw);
