            ...
            <div class="flex gap-1 sm:gap-2 items-center">
                <?php if ($loggedIn): ?>
                    ...
                    <a href="<?php echo $userRole == "buyer" ?
                        ...
                        ✉️
                        <?php if($msgCount > 0): ?>
                           <span id="msg-count" class="absolute top-1 right-1 text-[10px] bg-blue-600 text-white w-4 h-4
                           rounded-full flex items-center justify-center font-bold"><?= $msgCount; ?></span>
                        <?php else: ?>
                            <span id="msg-count" class="absolute top-1 right-1 text-[10px] bg-blue-600 text-white w-4 h-4
                           rounded-full flex items-center justify-center font-bold hidden">0</span>
                        <?php endif; ?>
                    </a>
                    ...
                    <?php if ($userRole == "buyer"): ?>
                        ...
                        <a href="watchlist.php" class="relative p-2 text-gray-600 hover:text-blue-600 hover:bg-blue-50
                    ...
                    <div class="relative ml-2 sm:ml-4 pl-2 sm:pl-4 border-1 border-gray-200">
                        <button
                            class="flex items-center gap-2 hover:bg-gray-50 px-2 py-1 rounded-lg transition-colors duration-200"
                            id="profileBtn">
                        ...
                        <div id="profileDropdown" class="absolute right-0 mt-3 w-56 bg-white rounded-lg shadow-lg border border-gray-100
                         opacity-0 invisible transition-all duration-200" style="display: none;">
                            ...
                            <div class="py-2">
                                ...
                                transition-colors duration-150">❤️ Watchlist</a>
                                <?php endif; ?>
